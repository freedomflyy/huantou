...
const SERVICE_CONTENT = {
  ...
  terms: {
    ...
    subtitle: "登录前请阅读核心条款",
    blocks: [
      { title: "服务说明", text: "幻头为你提供 AI 头像生成、风格迁移、编辑装饰等服务，部分功能会消耗积分。" },
      { title: "使用规范", text: "请勿上传侵权、违法或侵犯他人隐私的内容。对于违规内容，平台有权拒绝生成或下架。" },
      { title: "结果说明", text: "AI 生成结果存在一定随机性，最终成品以实际生成图为准，平台会持续优化体验。" },
    ],
  },
  privacy: {
    title: "隐私保护政策",
    subtitle: "我们如何使用你的资料",
    blocks: [
      { title: "授权范围", text: "登录时仅获取你授权提供的微信头像、昵称和登录凭证，用于建立账号和展示个人资料。" },
      { title: "图片处理", text: "你上传的图片仅用于头像生成、编辑和结果展示，不会用于与当前服务无关的用途。" },
      { title: "数据安全", text: "我们会尽量采用安全的存储与传输方式，并在业务结束后按规则管理相关数据。" },
    ],
  },
  feedback: {
    title: "意见反馈",
